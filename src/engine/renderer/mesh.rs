...
impl Mesh {
    pub fn make_cube(device: &wgpu::Device, dim: [f32; 3]) -> Self {
        ...
        let vertices: [Vertex; 24] = [
            // Front (+Z)
            Vertex {
                position: Vec3::new(x0, y0, z1),
            },
            Vertex {
                position: Vec3::new(x1, y0, z1),
            },
            Vertex {
                position: Vec3::new(x1, y1, z1),
            },
            Vertex {
                position: Vec3::new(x0, y1, z1),
            },
            // Back (-Z)
            Vertex {
                position: Vec3::new(x1, y0, z0),
            },
            Vertex {
                position: Vec3::new(x0, y0, z0),
            },
            Vertex {
                position: Vec3::new(x0, y1, z0),
            },
            Vertex {
                position: Vec3::new(x1, y1, z0),
            },
            // Left (-X)
            Vertex {
                position: Vec3::new(x0, y0, z0),
